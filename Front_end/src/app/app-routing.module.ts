...
const routes: Routes = [
  ...
  // { path: 'usereventList', component: UserEventsComponent },
  // { path: 'regevents', component: UserRegEventsComponent },
  {
    path: 'auth',
  ...
  },
  {
    path: 'userlayout',
    loadChildren: () =>
      import('./userlayout/userlayout.module').then((m) => m.UserlayoutModule),
  },
  {
    path: 'products',
    loadChildren: () =>
